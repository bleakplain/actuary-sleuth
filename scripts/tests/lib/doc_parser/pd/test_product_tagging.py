...
from lib.common.product_tags import (
    ContractRole, CustomerScope, HealthTermClass, ProductDesignType,
    ProductLine, ProductSubtype, ProductTags, ProductTermClass,
    ProductTermForm, RenewalType, TagEvidence,
)
...
@pytest.mark.parametrize(
    ("duration", "expected"),
    (
        ("365日", ProductTermClass.SHORT_TERM),
        ("366天", ProductTermClass.LONG_TERM),
        ("12个月", ProductTermClass.SHORT_TERM),
        ("13月", ProductTermClass.LONG_TERM),
        ("一年", ProductTermClass.SHORT_TERM),
